...
## v0.2 additions
You must protect the project against hidden platform creep.
You must ensure that:
- decision logs exist where material choices are made
- open questions are tracked rather than hand-waved
- demo status is never represented as production readiness
